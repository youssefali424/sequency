...
describe("asSequence", () => {
  ...
  it("should create sequence from object keys", () => {
    ...
    const array = asSequence(keys).toArray();
  ...
  it("should create sequence from object values", () => {
    ...
    const array = asSequence(values).toArray();
  ...
  it("should create sequence from set", () => {
    const array = asSequence(new Set([1, 2, 3])).toArray();
  ...
  it("should create sequence from map", () => {
    ...
    const array = asSequence(map).toArray();
  ...
  it("should throw understandable error message if input is undefined", () => {
    expect(() => asSequence(undefined as Array<number>).toArray()).toThrowError(
      "Cannot create sequence for input: undefined"
    );
  });

  it("should throw understandable error message if input is null", () => {
    expect(() => asSequence(null as Array<number>).toArray()).toThrowError(
      "Cannot create sequence for input: null"
    );
  });

  it("should throw understandable error message if input is not iterable", () => {
    expect(() => asSequence({} as Array<number>).toArray()).toThrowError(
      "Cannot create sequence for non-iterable input: [object Object]"
    );
  });
});
